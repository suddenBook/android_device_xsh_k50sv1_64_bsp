...
try:
 ...
 resolved=sh('search-launcher-component','cmd package resolve-activity --brief --user 0 -a android.intent.action.MAIN -c android.intent.category.LAUNCHER -p '+search_package).strip().splitlines()
